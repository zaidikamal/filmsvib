...
export default async function AdminDashboard() {
  ...
  const stats = [
    ...
    { label: "كفاءة النظام", value: "99.9%", icon: "⚡", trend: "مثالي", color: "from-green-600 to-emerald-500" },
  ]
           ...
           <div className="bg-[#12121a] border border-white/5 rounded-[2.5rem] p-8 shadow-2xl">
              ...
              <div className="space-y-4">
                {recentArticles && recentArticles.length > 0 ? recentArticles.map((art: any) => (
                  <div key={art.title} className="flex items-center justify-between p-5 bg-white/[0.02] border border-white/[0.05] rounded-[1.5rem] hover:bg-white/5 transition-all group">
